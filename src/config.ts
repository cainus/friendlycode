...
export const categories: CategoryDefinition[] = [
  ...
  },
  {
    ...
    subIssues: [
      ...
      { id: "3.3", categoryId: 3, name: "Schema validation presence", description: "zod/joi/yup imports", analysisType: "static" },
  ...
  },
  {
    ...
    subIssues: [
      ...
      { id: "7.7", categoryId: 7, name: "File name matches primary export", description: "File name reflects what it exports", analysisType: "static" },
    ],
  },
  {
    id: 8,
  ...
  },
  {
    ...
    subIssues: [
      ...
      { id: "10.2", categoryId: 10, name: "Middleware chain length", description: "Middleware layers per route", analysisType: "static" },
...
export const thresholds = {
  ...
  functionVerbPrefixes: ["get", "set", "create", "delete", "remove", "update", "validate", "check", "find", "fetch", "send", "handle", "process", "build", "make", "parse", "format", "convert", "calculate", "compute", "init", "load", "save", "render", "resolve"],
